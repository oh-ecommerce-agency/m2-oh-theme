...
<li><a title="Acerca de nosotros" href="/aboutus">Acerca de nosotros</a></li>
<li><a title="Tiendas" href="/tiendas">Tiendas</a></li>
<li><a title="Blog" href="/blog">Blog</a></li>
</ul></div></div></div><div class="pagebuilder-column-line" data-content-type="column-line" data-element="main" data-pb-style="FBSPLV1"><div class="pagebuilder-column column-newsletter" data-content-type="column" data-appearance="full-height" data-background-images="{}" data-element="main" data-pb-style="QT63A8F"><div data-content-type="text" data-appearance="default" data-element="main"><p>Suscribite a nuestro newsletter</p></div><div data-content-type="html" data-appearance="default" data-element="main" data-pb-style="K2421KV">{{block class="Magento\Newsletter\Block\Subscribe" name="form.subscribe.footer" template="Magento_Newsletter::subscribe.phtml" ifconfig="newsletter/general/active"}}</div></div><div class="pagebuilder-column column-social-networks" data-content-type="column" data-appearance="full-height" data-background-images="{}" data-element="main" data-pb-style="GWKRNWL"><div data-content-type="text" data-appearance="default" data-element="main"><p style="text-align: center;">¡Matente informado!</p></div><figure data-content-type="image" data-appearance="full-width" data-element="main" data-pb-style="S7U3JYW"><img class="pagebuilder-mobile-hidden" src="{{media url=wysiwyg/footer/instagram.png}}" alt="" title="" data-element="desktop_image" data-pb-style="YVDIR0P"><img class="pagebuilder-mobile-only" src="{{media url=wysiwyg/footer/instagram.png}}" alt="" title="" data-element="mobile_image" data-pb-style="HDHWW7H"></figure><figure data-content-type="image" data-appearance="full-width" data-element="main" data-pb-style="KX7G0QM"><img class="pagebuilder-mobile-hidden" src="{{media url=wysiwyg/footer/facebook.png}}" alt="" title="" data-element="desktop_image" data-pb-style="JMBH0RP"><img class="pagebuilder-mobile-only" src="{{media url=wysiwyg/footer/facebook.png}}" alt="" title="" data-element="mobile_image" data-pb-style="JR0EVX6"></figure><figure data-content-type="image" data-appearance="full-width" data-element="main" data-pb-style="LESARL2"><img class="pagebuilder-mobile-hidden" src="{{media url=wysiwyg/footer/tiktok.png}}" alt="" title="" data-element="desktop_image" data-pb-style="FIB2ST9"><img class="pagebuilder-mobile-only" src="{{media url=wysiwyg/footer/tiktok.png}}" alt="" title="" data-element="mobile_image" data-pb-style="YX6CYHP"></figure></div></div></div></div></div>
HTML
        ],
    ];
